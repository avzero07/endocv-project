...
% This script is used to illustrate how UNet-AV was constructed from
...
%% 2. Constructing UNet-AV

% This section assembles UNet-AV one layer at a time, and makes appropriate
% skip connections per the UNet design Paradigm. The overall design is
% similar to the Base UNet with an encoder depth of 4 (4 downsampling and
% upsampling layers).
...
layers = [
    ...
    pixelClassificationLayer('Name','labels','Classes',tbl.Name,'ClassWeights',classWeights) % As Defined in Section 1
...
figure, plot(lgraph), title('UNet-AV')
...
%
% The Lines below (line 220 and below) may be uncommented to run a few iterations of training. 
